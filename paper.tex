...
The Ordered Decomposition DAGs kernel framework (ODD)~\cite{Dasan2012} considers as non-zero features in the RKHS the trees that appear as subtrees of the input graphs.
