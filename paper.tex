...
\label{MKL}
MKL \cite{Gonen2011} is one of the most popular paradigms in real world applications \cite{Bucak2014} used to learn kernels as a combination of different base kernels $\KK_1,...,\KK_R$. % Zien2007,Wang2015a,Sun
...
%, based on the robustness of the combination vector $\boldsymbol{\eta}$ when considering just a subset of the available data.
...
dataset & \# train &\kval &\kmkl &\ksum & \ksmkl & \kssum & \ksw \\
\hline
MUTAG   & 188 & \res{0.90}{0.08} & \res{0.93}{0.06} & \res{0.93}{0.06} & \res{0.93}{0.05} & \res{0.93}{0.05} & \res{0.93}{0.05}    \\
&			  & 18m					& 40m				& 8m		& 3m		&4m		&4m\\\hline
CPDB    & 684 & \res{0.88}{0.03} & \res{0.88}{0.03} & \res{0.88}{0.03} & \res{0.88}{0.02} & \res{0.89}{0.03} 	& \res{0.88}{0.02} \\
&			  & 1h 16m				& 8h 33m		& 20m	& 1h 37m		& 5m		&5m\\\hline
GDD     & 1178 & \res{0.86}{0.05} & \res{0.87}{0.04} & \res{0.87}{0.04} & \res{0.87}{0.04} & \res{0.87}{0.04} & \res{0.80}{0.04}    \\
&			& $>$100h	& $>$100h	& $>$100h	&3h		& 4h 15m		& 4h 15m\\\hline
AIDS    & 1503 & \res{0.78}{0.08} & \res{0.78}{0.08} & \res{0.78}{0.08} & \res{0.78}{0.08} & \res{0.77}{0.07} & \res{0.77}{0.07}    \\
&		& 6h 39m		& 50h	& 2h 44m		& 11h 10m	& 1h 4m	& 1h 4m\\\hline
NCI1    & 4110 & \res{0.88}{0.04} & - & \res{0.89}{0.04} & \res{0.88}{0.04} & \res{0.88}{0.05} & \res{0.88}{0.04}    \\
&	&	39h	&-	& 7h 24m		& 98h	& 2h 1m	& 2h 1m\\\hline
NCI109 & 4127 & \res{0.87}{0.03} & - & \res{0.87}{0.03} & \res{0.87}{0.02}  & \res{0.87}{0.03} & \res{0.87}{0.02}  \\
&	&	44h	&-	& 7h 36m		& 99h	& 1h 47m	& 1h 47m\\\hline
CAS     & 4337 & \res{0.92}{0.01} & - & \res{0.92}{0.01} & \res{0.92}{0.01} & \res{0.92}{0.01} & \res{0.92}{0.01}    \\
&	&	38h	&-	& 4h 26m		&$>$100h	& 1h 34m		& 1h 34m\\	%176h
\hline\hline
\end{tabular}}
\caption{AUC score, standard deviation and computational time for all baselines and all subsampling proposed methods.}
