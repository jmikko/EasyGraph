...
to efficiently select just a small number of kernels without loss in
...
information loss is often unavoidable. Direct processing of structures is
possible using a kernelized approach, where a kernel function can be devised
for each generic data type (for example sequences, trees or graphs). This in
turn allows to use standard learning algorithms (e.g. SVM) to solve the
predictive task.
